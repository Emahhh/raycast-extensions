...
import { displayDueDate, displayDueDateTime, isExactTimeTask } from "../helpers/dates";
                ...
                {reminders.length > 0 ? (
                  <Detail.Metadata.TagList title="Reminders">
                    {reminders.map((reminder) => (
                      <Detail.Metadata.TagList.Item key={reminder.id} text={displayDueDateTime(reminder.due.date)} />
                    ))}
                  </Detail.Metadata.TagList>
                ) : null}
